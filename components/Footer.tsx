    ...
    <footer className={`mt-auto relative ${showAnimation ? 'animate-fadeIn' : ''}`}>
       ...
       >
         <div className="flex justify-center">
           <div
             ref={containerRef}
             className="relative w-fit rounded-full px-1 py-1 bg-black bg-opacity-80 backdrop-blur-sm"
             style={{ 
          ...
          <div
            className="absolute top-[2px] left-[2px] h-[calc(100%-4px)] bg-white rounded-full transition-all duration-300 ease-out shadow-sm"
            style={pillStyle}
          />
              ...
              {navLinks.map((link, index) => {
                  ...
                  <Link
                    ...
                    className={`px-4 py-2 text-sm transition-all duration-200 hover:opacity-80 ${
                      activeIndex === index ? 'text-black font-medium' : 'text-white'
                    }`}
                    style={{
                      ...uiFont,
